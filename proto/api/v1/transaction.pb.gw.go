...
func request_TransactionCommandService_CreateTransaction_0(ctx context.Context, marshaler runtime.Marshaler, client TransactionCommandServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := marshaler.NewDecoder(req.Body).Decode(&protoReq.Transaction); err != nil && err != io.EOF {
...
func request_TransactionCommandService_DeleteAllTransactions_0(ctx context.Context, marshaler runtime.Marshaler, client TransactionCommandServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq DeleteAllTransactionsRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.DeleteAllTransactions(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_TransactionCommandService_DeleteAllTransactions_0(ctx context.Context, marshaler runtime.Marshaler, server TransactionCommandServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq DeleteAllTransactionsRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.DeleteAllTransactions(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterTransactionCommandServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server TransactionCommandServiceServer) error {
	...
	mux.Handle("POST", pattern_TransactionCommandService_DeleteAllTransactions_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/api.v1.TransactionCommandService/DeleteAllTransactions", runtime.WithHTTPPathPattern("/api.v1.TransactionCommandService/DeleteAllTransactions"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_TransactionCommandService_DeleteAllTransactions_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_TransactionCommandService_DeleteAllTransactions_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterTransactionCommandServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client TransactionCommandServiceClient) error {
	...
	mux.Handle("POST", pattern_TransactionCommandService_DeleteAllTransactions_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/api.v1.TransactionCommandService/DeleteAllTransactions", runtime.WithHTTPPathPattern("/api.v1.TransactionCommandService/DeleteAllTransactions"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_TransactionCommandService_DeleteAllTransactions_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_TransactionCommandService_DeleteAllTransactions_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"api.v1.TransactionCommandService", "DeleteAllTransactions"}, ""))
)

var (
	forward_TransactionCommandService_CreateTransaction_0 = runtime.ForwardResponseMessage

	forward_TransactionCommandService_DeleteAllTransactions_0 = runtime.ForwardResponseMessage
)
