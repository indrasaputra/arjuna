...
var file_api_v1_user_proto_rawDesc = []byte{
	...
	0x65, 0x20, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x66, 0x69, 0x65, 0x72, 0x2e, 0x42, 0x85, 0x02,
...
var file_api_v1_user_proto_depIdxs = []int32{
	...
	3, // 1: api.v1.RegisterUserResponse.data:type_name -> api.v1.User
	5, // 2: api.v1.User.created_at:type_name -> google.protobuf.Timestamp
	5, // 3: api.v1.User.updated_at:type_name -> google.protobuf.Timestamp
	...
	2, // 6: api.v1.UserCommandService.RegisterUser:output_type -> api.v1.RegisterUserResponse
