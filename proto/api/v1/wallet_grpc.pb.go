...
// UnimplementedWalletCommandServiceServer must be embedded to have
...
func (UnimplementedWalletCommandServiceServer) testEmbeddedByValue()                              {}
...
func RegisterWalletCommandServiceServer(s grpc.ServiceRegistrar, srv WalletCommandServiceServer) {
	// If the following call pancis, it indicates UnimplementedWalletCommandServiceServer was
