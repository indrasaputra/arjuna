...
//
//	mockgen -source=./service/user/internal/service/user_getter.go -destination=./service/user/test/mock//service/user_getter.go
//
...
func (mr *MockGetUserMockRecorder) GetAll(ctx, limit any) *gomock.Call {
...
// GetAll indicates an expected call of GetAll.
func (mr *MockGetUserRepositoryMockRecorder) GetAll(ctx, limit any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
